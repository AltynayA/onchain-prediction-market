...
contract CPMMHandler is Test {
    ...
    constructor(CPMM c, OutcomeToken t, address a) {
        ...
        totalLpTracked = cpmm.lpBalance(address(1));
    }
...
contract CPMMInvariantTest is Test {
    ...
    /// inv-1: reserve product should remain valid
    ...
    /// inv-2: total lp supply must cover actor + locked lp
    ...
    /// inv-3: reserves must be backed by real token balances
...
// handler contract for market invariant fuzzing
...
contract MarketInvariantTest is Test {
    ...
    /// inv-4: market collateral accounting must match actual balance
    ...
    /// inv-5: yes + no shares should equal tracked collateral
